...
лекал под Ваш автомобиль</strong>
      ...
      <button class="button" :class="{disabled: disabled}" @click.prevent="sendData" onClick="gtag('event', <click>, {'event_category': <links>,  'event_label': <proverit>});">Проверить</button>
    </div>
    <div class="column">
